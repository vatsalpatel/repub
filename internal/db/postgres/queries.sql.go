...
func (q *Queries) GetLatestPackageVersion(ctx context.Context, packageID int32) (PackageVersion, error) {
...
SELECT id, name, private, description, homepage, repository, documentation, topics, download_count, like_count, created_at, updated_at FROM packages WHERE name = $1
`
...
func (q *Queries) GetPackageUploaders(ctx context.Context, packageID int32) ([]string, error) {
...
func (q *Queries) GetPackageVersions(ctx context.Context, packageID int32) ([]PackageVersion, error) {
...
func (q *Queries) IncrementPackageDownloadCount(ctx context.Context, id int32) error {
